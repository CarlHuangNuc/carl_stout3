...
class Qwen2_5OmniForConditionalGeneration(Qwen2_5OmniPreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        print(f"Generated {thinker_total_tokens} tokens")

        total_tokens = thinker_get_tokens.shape[1]
        while thinker_get_tokens.shape[1] == carl_custom_think_token and total_tokens < 2000:
            ...
            start_time_testa = time.perf_counter()
            execution_time = start_time_testa - start_time_test3
            print(f"text执行时间: {execution_time:.6f} 秒")
            ...
            if thinker_total_tokens > carl_custom_think_token:
                print(thinker_total_tokens)
                thinker_reply_part =thinker_reply_part[:,20:,:]
            ...
            print(wav.shape)
            yield wav.float()
            start_time_testb = time.perf_counter()
            execution_time = start_time_testb - start_time_testa
            print(f"text执行时间: {execution_time:.6f} 秒") 
            '''
            if thinker_total_tokens > carl_custom_think_token:
                sf.write("./merge_tttt.wav", wav.reshape(-1).detach().cpu().numpy(),samplerate=24000,)
                return
            '''
            ...
            while (talker_get_tokens.shape[1] == carl_custom_talker_tokens and total_tokens < 2000) or (thinker_total_tokens > carl_custom_think_token and total_tokens < 2000):
                ...
                if thinker_total_tokens > carl_custom_think_token:
                    ...
                    print("remove ...final ..tokens ...end flag")
                    print(cache_length)
